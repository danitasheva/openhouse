...
function CommunitiesList() {
  ...
  homesInitState.forEach((home: HomeType) => {
  ...
  console.log("communities updated arr", communities); // Updated community array with averagePrice property
